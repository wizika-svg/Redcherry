...
export function PremiumPromoBanner() {
  ...
  // ─── Design Tokens ──────────────────────────────────────────────────────
  const labelCls =
    "text-[10px] font-bold text-muted-foreground uppercase tracking-[0.15em]";
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed top-1/2 left-1/2 z-[100] max-w-sm w-full flex justify-center px-4"
        >
          <div className="relative overflow-hidden p-5 rounded-2xl bg-[#0a0f1a]/80 border border-[rgba(45,212,140,0.2)] shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl">
            ...
            <div className="space-y-5">
              ...
              <p className="text-xs text-[rgba(255,255,255,0.6)] leading-relaxed font-medium">
                Access the{" "}
                <span className="text-[#2DD48C]">
                  rarest and craziest videos
                </span>{" "}
                on the platform. Exclusive content curated for those who demand
                the highest quality...
              </p>
              ...
              <button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #2DD48C 0%, #388BFD 100%)",
                }}
              >
